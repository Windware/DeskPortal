$self.tip = new function() //Tip related class
{
	...
	var _design = $system.text.format('%%server/php/run.php?task=tip.make&color=333333&background=%%&border=333333&edge=1&shadow=1&round=1&place=cm&through=%%', [$system.info.root, _background.color, _background.opacity])
