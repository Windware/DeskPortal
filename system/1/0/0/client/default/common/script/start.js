...
root %
.
system_ % version % = {} //Create the system object first, so that this object exists during the initialization
...
%
	root %
.
	system_static //Keep the globally used variables easily reachable

	var $self =
%
	root %
.
	system_ % version % //Keep the system itself accessible from own scripts
...
%
	root %
.
	start = function() { $self.run() } //Link the top level 'main.start' as this system's 'start' function
