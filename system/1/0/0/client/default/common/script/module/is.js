$self.is = new function() //Variable inspection class
{
	...
	this.identity = function(identity) { return $system.is.mail(identity) } //Check if the given string is an unique user identity
	...
	this.mail = function(address) { return $system.is.text(address, false, /.@./) } //Check if the given string is a mail address, in a simple way
