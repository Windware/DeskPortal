...
if(!$code) //If the JavaScript cache cannot be retrieved, create it
{
	...
	$source = ['%demo%', '%demo_identity%', '%demo_password%'];
	$replacer = [$conf['system_demo'] ? 'true' : 'false', $demo['identity'], $demo['password']];
	...
	$extensions = []; //List of file type extensions for each languages
