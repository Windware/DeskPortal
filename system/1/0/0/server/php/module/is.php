<?php
	...
	{
		public static function address($address) { return is_string($address) && preg_match('|^https?://[0-9a-z\-]+|', $address); } //Finds if it is a web address

		public static function color($color) { return is_string($color) && preg_match('/^[0-9a-f]{6}$/', $color); } //Finds if it is a color code
		...
		public static function mail($address) { return !!preg_match('/.@./', $address); } //Find out if the given string is a mail address or not, in a simple way
