...
class System_1_0_0_Minify
{
	...
	public static function html(&$system, $text) //Minify HTML (and included CSS/JS)
	{
		...
		foreach(['html', 'css', 'js'] as $section) $system->file_load("{$system->system['root']}server/php/module/minify_$section.php"); //Load the library manually

		$external = ['jsMinifier' => ['System_1_0_0_Minify_Js', 'minify'], 'cssMinifier' => ['System_1_0_0_Minify_Css', 'minify']];
