<?php
	if($_GET['type'] != 'png' && $_GET['type'] != 'ico') exit;
	...
	$_GET['_self'] = 'system/'.str_replace('_', '/', System_Static::app_conf('system', 'static', 'system_version'))."/component/default/computer/graphic/icon.{$_GET['type']}";
