...
class System_Static_Database
{
	public static function charset($type) #Returns part of the table creation query to determine the character set
	{
		switch($type)
		{
			case 'sqlite' :
				return '';
			break; #SQLite3 does not support table level character encoding

			default :
				return ' DEFAULT CHARACTER SET utf8';
			break; #Set client connection character set
		}
	}

	public static function connection($sector, $type, $host, $port, $database)
	{
		switch($sector)
		{
