var %
root % = //Create the top most object of the entire system in the DOM tree
	{
		system_static: new function()
		{
			...
			this.demo = {mode: % demo %, identity
		:
			'%demo_identity%', password
		:
			'%demo_password%'
		}
			 //Whether this is under demo mode or not

			this.extensions = { % extension %
		}
			 //List of available server side languages and their extension
...
system_static.top =
%
root % //Give a relative reference to the top most object for other applications
