$self.search = new function()
{
	...
	this.dictionary = function(value, mode) //Dictionary search
	{
		...
		{
			case 'en' :
				var address = 'http://www.google.com/dictionary?q=%%&hl=%%&langpair=en%7Cen'
				break

			case 'ja' :
				var address = 'http://dic.yahoo.co.jp/dsearch?p=%%&enc=UTF-8&stype=0&dtype=0'
				break
	...
	this.web = function(value, mode) //Web search
	{
		...
		{
			case 'page' :
				var address = 'https://www.google.com/search?hl=%%&q=%%'
				break

			case 'image' :
				var address = 'https://image.google.com/images?hl=%%&q=%%'
				break
	...
	this.wikipedia = function(value, mode) //Wikipedia search
	{
		...
		{
			case 'en' :
				var address = 'https://en.wikipedia.org/wiki/%%'
				break

			case 'ja' :
				var address = 'https://ja.wikipedia.org/wiki/%%'
				break
