	...
	$self.gui = new function()
	{
		...
		this.list = function(year, month, callback) //Set the calendar to a specific month
		{
			...
			return $system.network.send($self.info.root + 'server/php/run.php', {task : 'item.get', year : __current.year, month : __current.month}, null, $system.app.method(set, [callback]));
		}
