	...
	$self.address = new function()
	{
		...
		this.list = function(index) //Load the addresses
		{
			...
			return $system.network.send($self.info.root + 'server/php/run.php', {task : 'address.list', group : form.group.value, type : form.type.value}, null, $system.app.method(display, [form.type.value, index]));
		}
